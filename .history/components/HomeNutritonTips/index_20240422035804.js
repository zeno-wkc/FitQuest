      ...
      <div className={styles.homeNutritonTipsContentContainer}>
        <Link className={styles.cardContainerLink} href="/homepage">
          <div className={styles.cardContainer}>
            <Image className={styles.cardImage} src="/card-3.png" width={400} height={164} alt="card image background" />
        ...
        <Link className={styles.cardContainerLink} href="/hompage">
          <div className={styles.cardContainer}>
            <Image className={styles.cardImage} src="/card-1.png" width={400} height={164} alt="card image background" />
            <div className={styles.contentContainer}>
