...
export default function Question() {
  ...
  return (
    ...
    <form onSubmit={(e) => {e.preventDefault(); submitAnswer(parseInt(questions[1].id), selectedOption)}}>
    ...
    <form onSubmit={(e) => {e.preventDefault(); submitAnswer(parseInt(questions[4].id), selectedOption)}}>
