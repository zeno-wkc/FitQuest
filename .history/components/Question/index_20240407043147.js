...
export default function Question() {
  ...
  return (
    <div className={styles.quizContainer}>
      ...
      { 
        currentQuestion === 0 ? (
          <form onSubmit={(e) => {e.preventDefault(); submitAnswer(currentQuestion, answerObject); setCurrentQuestion(prevIndex => prevIndex + 1); } }>
        ...
        <button type="submit">OK</button><button onClick={handleQuestion('prev')}>Prev</button>
