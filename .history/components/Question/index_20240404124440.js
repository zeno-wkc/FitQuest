...
export default function Question() {
  ...
  const { answerLabel } = questions[activeQuestion][answers][answerLabel];

  console.log(questions);
  console.log('Q:', question); 
  console.log('A:', answers);
  console.log('AL:', answerLabel);
  ...
  return (
    ...
    <div className={styles.questionContainer}>
      ...
      <ul>
        ...
        { !showAns ? (<li>{Object.keys(answers).forEach((key, index) => {console.log(key, index)})}</li>) : <></>
        }
      </ul>
    </div>
    </>
