  ...
  return (
    <div className={styles.quizContainer}>
      ...
      <div className={styles.questionContainer}>
        <form onSubmit={(e) => { e.preventDefault(); console.log(e); handleFinalAnswer(currentQuestion, answerObject); currentQuestion !== 4 ? handleQuestion('next') : ''; }}>
          ...
          }
          {
            currentQuestion === questions.length - 1
              ...
              : (<>
                <button name="prev" type="submit">Prev</button>
                <button name="next" type="submit" onClick={(e) => console.log(e);}>Next</button>
              </>)
          }
