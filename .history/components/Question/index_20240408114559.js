            ...
            <label className={styles.questionlabel}>{question}</label>
            {
              currentQuestion === 0 ? (
                ...
                currentQuestion === 4 ? (
                  ...
                  answers.map((k, i) => (
                    <div className={styles.answerContainer}>
                      <label className={styles.inputRadio} className={styles.label} key={i} htmlFor={k.answerTag}>{k.answerId}. {k.answerLabel} {currentQuestion === 3 ? (<p className={styles.answerDesc}>{k.answerDesc}</p>) : ''}</label>
                      <input
                        type="radio"
