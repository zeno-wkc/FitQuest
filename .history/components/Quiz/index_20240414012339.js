...
export default function Question() {
  ...
  const checkAllAnswersFilled = () => {
    ...
    console.log(Object.values(currentAnswers).length !== 0 && Object.values(currentAnswers).length < 3 && Object.values(currentAnswers).every(value => value !== null && value !== undefined && value !== ''));

    switch (type) {
      case 'input':
        return Object.values(currentAnswers).length !== 0 && Object.values(currentAnswers).length < 3 && Object.values(currentAnswers).every(value => value !== null && value !== undefined && value !== '');
      case 'radio':
...
//   const checkAllAnswersFilled = () => {
//     const currentAnswers = answers[currentQuestion];
//     console.log(Object.values(currentAnswers));
//     switch (type) {
//       case 'input':
//         return Object.values(currentAnswers).every(e => e !== "" || e.lenght[0]);
//       case 'radio':
//         return Object.values(currentAnswers).some(value => value !== "");
//       case 'checkbox':
//         return Object.values(currentAnswers).some(value => value);
