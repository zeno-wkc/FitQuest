...
export default function Question() {
  ...
  const checkAllAnswersFilled = () => {
    ...
    const requiredFields = questionType === "checkbox" ? Object.keys(currentAnswers).filter(key => key.includes("Answer")) : ["Answer"];
    return requiredFields.every(field => currentAnswers[field]);
  };
