    ...
    <>
      ...
      <div className={styles.quizContainer}>
        <div className={styles.bannerContainer}>
          ...
          <div className={styles.quizSumOfQuestion}> { currentQuestion != 0 && ( <button className={styles.prevQuestionBtn} onClick={() => handleSelectQuestion('prev')}>&#60; Question {currentQuestion + 1}/{questions.length}</button>) }</div>
        </div>
