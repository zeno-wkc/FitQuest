    ...
    return (
      ...
      <div className={styles.answerContainer}>
        <input type="radio"
          ...
          name={currentQuestion}
          value={k.answerTag}
          onChange={(e) => {console.log(e.target.value); handleAnswer(setRadioAnswer, k.answerTag, e.target.value);  setActiveSet('radioAnswer');}}
        />
    ...
    return (
      ...
      <div className={styles.answerContainer}>
        <input type="checkbox"
          ...
          name={currentQuestion}
          value={k.answerTag}
          onChange={(e) => {console.log(e.target.value); handleAnswer(setCheckboxAnswer, k.answerTag, e.target.value);  setActiveSet('checkboxAnswer');}}
        />
