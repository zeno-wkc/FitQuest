...
export default function Question() {
  ...
  const checkAllAnswersFilled = () => {
    ...
    console.log(Object.values(currentAnswers).every(value => Array.isArray(value) && value.length));

    switch (type) {
      case 'input':
        return Object.values(currentAnswers).every(value => Array.isArray(value) && value.length);
        // return false;
      case 'radio':
