...
export default function Question() {
  ...
  const handleFinishQuestion = () => {
    ...
    Object.entries(finalAnswers[4]).map((k, v) => {
      switch (k[0]) {
        case 'Answer1':
          return finalAnswers[4]['Answer1'] ? finalAnswers[4]['Answer1'] = 'neckPain' : finalAnswers[4]['Answer1'] = false;
        case 'Answer2':
          return finalAnswers[4]['Answer2'] ? finalAnswers[4]['Answer2'] = 'backPain' : finalAnswers[4]['Answer2'] = false;
        case 'Answer3':
          return finalAnswers[4]['Answer3'] ? finalAnswers[4]['Answer3'] = 'shoulderPain' : finalAnswers[4]['Answer3'] = false;
        case 'Answer4':
          return finalAnswers[4]['Answer4'] ? finalAnswers[4]['Answer4'] = 'kneePain' : finalAnswers[4]['Answer4'] = false;
        case 'Answer5':
          return finalAnswers[4]['Answer5'] ? finalAnswers[4]['Answer5'] = 'all' : finalAnswers[4]['Answer5'] = false;
        default : return null; 
      }
    })
