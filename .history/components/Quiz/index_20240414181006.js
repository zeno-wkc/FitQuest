...
export default function Question() {
  ...
  const handleFinishQuestion = () => {
    ...
    const arr = finalAnswers[4].filter(function(item) { return item.Answer1 !== false });
    consolr.log(arr);
    Object.entries(finalAnswers[4]).map((k, v) => {
      (object[key] === false) ? delete object[key] : null;
      switch (k[0]) {
        case 'Answer1':
          return finalAnswers[4]['Answer1'] = 'neckPain';
        case 'Answer2':
          return finalAnswers[4]['Answer2'] = 'backPain';
        case 'Answer3':
          return finalAnswers[4]['Answer3'] = 'shoulderPain';
        case 'Answer4':
          return finalAnswers[4]['Answer4'] = 'kneePain';
        case 'Answer5':
          return finalAnswers[4]['Answer5'] = 'all';
        default : return null; 
      }
    })
