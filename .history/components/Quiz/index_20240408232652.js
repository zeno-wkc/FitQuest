    ...
    return (
      ...
      {(() => answers.map((k, i) => (
        <input type="number"
          ...
          onChange={(e) => {handleAnswer(setInputAnswer, k.answerTag, e.target.value);  setActiveSet('setInputAnswer');}}
        />
      )))()}
      </>
    )
  ...
  return (
    <>
      ...
      <div className={styles.quizContainer}>
        ...
        <button onClick={(e) => handleAnswer(setFinalAnswer, currentQuestion, inputAnswer)}>Next</button>
      </div>
    </>
  )
}