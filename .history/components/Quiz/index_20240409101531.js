...
export default function Question() {
  ...
  const handleAnswer = (functionName, result, key, e, checkValue) => {
    ...
    console.log(functionName.slice(3));
    !checked ? delete functionName.slice(3)[key] : "";
    ...
    return (
      ...
      <div className={styles.answerContainer}>
        <input type="checkbox"
          ...
          name={currentQuestion}
          value={k.answerTag}
          onChange={(e) => {handleAnswer(setCheckboxAnswer, 'checkAnswer', 'Answer' + k.answerId, e);  setActiveSet('checkboxAnswer');}}
        />
