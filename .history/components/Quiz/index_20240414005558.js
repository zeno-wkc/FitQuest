...
export default function Question() {
  ...
  const checkAllAnswersFilled = () => {
    ...
    console.log(Object.values(currentAnswers).length !== 0 && Object.values(currentAnswers).every(value => value.length !== 0 || value !== null || value !== ''));

    switch (type) {
      case 'input':
        return Object.values(currentAnswers).length !== 0 || Object.values(currentAnswers).every(value => value.length !== 0 || value !== null || value !== '');
      case 'radio':
