          ...
          case 'beginner':
            return (
              <div className={styles.levelContainer}>
                ...
                <Image className={styles.cardImage} src="/Beginner.png" width={400} height={164} alt="homepage background" />
          ...
          case 'intermediator':
            return (
              <div className={styles.levelContainer}>
                ...
                <Image className={styles.cardImage} src="/Intermediate.png" width={400} height={164} alt="homepage background" />
          ...
          case 'advance': 
            return (
              <div className={styles.levelContainer}>
                ...
                <Image className={styles.cardImage} src="/Advanced.png" width={400} height={164} alt="homepage background" />
