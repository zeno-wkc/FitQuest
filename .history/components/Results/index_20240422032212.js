...
export default function Result({finalAnswers}) {
  ...
  const level = (data) => {
    ...
    switch (data) {
      case 'beginner': return {`<div><h1>Beginner Level!</h1><p>It’s good to start doing more exercises from now on! You can find below the workout videos we recommend to you!</p></div>`};
  ...
  return (
    ...
    <div className={styles.videoCardContainer}>
      {(() => {
        switch (finalAnswers[1].Answer) {
            case 'beginner':
                return `<div><h1>Beginner Level!</h1><p>It’s good to start doing more exercises from now on! You can find below the workout videos we recommend to you!</p></div>`;
              case 'intermediator':
                return `<div><h1>Beginner Level!</h1><p>It’s good to start doing more exercises from now on! You can find below the workout videos we recommend to you!</p></div>`;
              case 'advance': 
                return `<div><h1>Beginner Level!</h1><p>It’s good to start doing more exercises from now on! You can find below the workout videos we recommend to you!</p></div>`;
