          ...
          case 'beginner':
            return (
              <div className={styles.levelContainer}>
                ...
                <Image className={styles.cardImage} src="/Beginner.png" width={314} height={190} alt="Beginner icon image" />
          ...
          case 'intermediator':
            return (
              <div className={styles.levelContainer}>
                ...
                <Image className={styles.cardImage} src="/Intermediate.png" width={314} height={190} alt="Intermediate icon image" />
          ...
          case 'advance': 
            return (
              <div className={styles.levelContainer}>
                ...
                <Image className={styles.cardImage} src="/Advanced.png" width={314} height={190} alt="Advanced icon image" />
