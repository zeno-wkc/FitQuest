      ...
      <div className={styles.quizContainer}>
        ...
        <div className={styles.contentContainer}>
          ...
          <div className={styles.quizContainer}>
            ...
            <div>
              { currentQuestion != 4 && ( <button className={styles.nextBtn} onClick={() => handleSelectQuestion('next')}>Next</button>) }
              { currentQuestion === 4 && ( <button className={styles.finishBtn} onClick={() => handleFinishQuestion()}>Finish</button>) }
            </div>
          </div>
        </div>
      </div>
      {showPopup && (
        <div className={`${styles.popupContainer} ${styles.overlay}`}>
          <div className={styles.popupContent}>
            ...
            <button className={styles.closeBtn} onClick={handleClosePopup}>OK</button>
          </div>
        </div>
      )}</>)}
    </>
